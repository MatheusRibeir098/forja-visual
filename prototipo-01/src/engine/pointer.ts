...
/** Mesmo fov da câmera padrão do protótipo; `setCamera` sobrescreve no boot. */
...
function getTargetRect(target: EventTarget): { left: number; top: number; width: number; height: number } {
